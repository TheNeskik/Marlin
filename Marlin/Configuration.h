...
#define STRING_CONFIG_H_AUTHOR "(Axel G, Config_11092020)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "AMKS8"
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 23, 5, -0.275 }
